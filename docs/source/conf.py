# -*- coding: utf-8 -*-
# CIRpy documentation build configuration file, created by sphinx-quickstart on Tue Mar 24 16:12:38 2015.
...
latex_documents = [
  ('index', 'CIRpy.tex', u'CIRpy Documentation', u'Matt Swain', 'manual'),
]
...
man_pages = [
    ('index', 'cirpy', u'CIRpy Documentation', [u'Matt Swain'], 1)
]
...
texinfo_documents = [
    ('index', 'CIRpy', u'CIRpy Documentation', u'Matt Swain', 'CIRpy',
...
epub_title = u'CIRpy'
epub_author = u'Matt Swain'
epub_publisher = u'Matt Swain'
epub_copyright = u'2015, Matt Swain'

# The basename for the epub file. It defaults to the project name.
#epub_basename = u'CIRpy'

# The HTML theme for the epub output. Since the default themes are not optimized for small screen space, using the same
# theme for HTML and epub output is usually not wise. This defaults to 'epub', a theme designed to save visual space.
#epub_theme = 'epub'
